                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="date" type="date"
                                               ...
                                               name="date" value="{{ old('date') }}" placeholder="Enter date">
                                                ...
                                                <select name="account_id" id="account_id" class="form-control @error('account_id') is-invalid @enderror">
                                                    ...
                                                    @forelse($accounts as $account)
                                                        <option value="{{$account->id}}"
                                                                ...
                                                                @endif
                                                        >
                                                            {{$account->account_no}} - ( {{$account->bank[0]->name}} )
                                                        </option>
                                                    @empty
                                    ...
                                    <div id="type_section">
                                        <div class="form-group">
                                            ...
                                            <select name="type" id="type" class="form-control type">
                                                ...
                                                <option value="2" >Balance Transfer</option>
                                            </select>
                                    ...
                                    <div id="balance_transfer_section">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="1" class="form-control autosize-input"
                                                      ...
                                                      placeholder="Payment Details Like Cheque Number, Bank Name...">{{ old('balance_transfer_info') }}</textarea>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="remarks" id="" cols="30" rows="5">{{old('remarks')}}</textarea>
                                        <div class="help-block with-errors"></div>
