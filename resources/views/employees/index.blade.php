      ...
      <div class="col-lg-4">
        <nav class="breadcrumb-container" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
              <a href="#">{{ __('label.EMPLOYEE_LIST')}}</a>
            </li>
          </ol>
        </nav>
      </div>
    ...
    <div class="col-md-12">
      <div class="card p-3">
        <div class="card-header">
          <h3>{{ __('label.EMPLOYEE_LIST')}}</h3>
          <div class="card-header-right">
              <a href="{{url('/employees/create')}}" class="btn btn-primary">  @lang('label.CREATE')</a>
          </div>
      </div>
        <div class="card-body">
          <table  class="table">
