...
@section('title', 'Create Item Inventory')
@section('content')
        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5>{{ __('label.ADD_ITEM_INVENTORY')}}</h5>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <nav class="breadcrumb-container" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="#">{{ __('label.ADD_ITEM_INVENTORY')}}</a>
                        </li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="col-md-12">
            <div class="card ">
                <div class="card-header">
                    <h3>{{ __('label.ADD_ITEM_INVENTORY')}}</h3>
                </div>
                <div class="card-body">
                    <form class="forms-sample" method="POST" action="{{ url('item-inventory') }}" >
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="name">{{ __('label.ITEM_NAME')}}<span class="text-red">*</span></label>
