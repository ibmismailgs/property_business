      ...
      <div class="col-lg-4">
        <nav class="breadcrumb-container" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
              <a href="#">{{ __('label.PACKAGE_TYPE')}}</a>
            </li>
          </ol>
        </nav>
      </div>
      ...
      <div class="card p-3">
        <div class="card-header">
          ...
          <div class="card-header-right">
              <a href="{{url('package-type/create')}}" class="btn btn-primary">  @lang('label.CREATE')</a>
          </div>
      </div>
        <div class="card-body">
          <table  class="table">
