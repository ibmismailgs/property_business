      ...
      <div class="card p-3">
        <div class="card-header">
          ...
          <div class="card-header-right">
              <a href="{{url('project-assign/create')}}" class="btn btn-primary">  @lang('label.CREATE')</a>
          </div>
      </div>
        <div class="card-body">
          <table  class="table">
